"""The outcome-scale conversion, shared by the model and the evaluation harness.
...
squashed to a probability instead - only then is y1 - y0 a risk difference rather than
a log-odds ratio. One definition, torch or numpy, so the two callers cannot drift.
"""
